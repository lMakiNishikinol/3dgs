...
const bridgeModulePath = new URL('../.artifacts/canvas-bridge-build/canvas-bridge.js', import.meta.url)
const threeModulePath = new URL('../node_modules/threejs-miniprogram/dist/index.js', import.meta.url)
const { createMiniProgramCanvasBridge } = await import(bridgeModulePath)
const { createScopedThreejs } = await import(threeModulePath)
